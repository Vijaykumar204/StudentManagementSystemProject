...
public interface EmailSentService {
	...
	MessageResponse sendQuarterlyAttendanceReport(String quarterAndYear, Integer classOfStudy, Long teacherId)
			throws MessagingException;

	MessageResponse sendQuarterlyMarkResult(String quarterAndYear, Integer classOfStudy, Long teacherId)
			throws MessagingException;
